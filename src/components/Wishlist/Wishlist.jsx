...
const Wishlist = ({book}) => {
    ...
    return (
        <div>
            <div className="p-6 flex gap-6 border-2 rounded-2xl mb-6">
                        ...
                        <div className="w-full">
                            ...
                            <div className="flex gap-3">
                                ...
                                <Link to={`/books/${bookId}`}><button className="btn text-xl font-bold text-white bg-[#23BE0A] w-auto rounded-full">View Details</button></Link>
                            </div>
                        </div>
                    </div>
        </div>
